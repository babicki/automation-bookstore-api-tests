...
/**
 * Step definitions for negative tests.
 * Handles scenarios where users try unauthorized actions like adding books to the global catalog.
 */
public class AddBookToCatalogSteps {
    ...
    /**
     * Tries to add a new book to the global catalog without authorization.
     * Regular users are not allowed to modify the shared catalog.
     */
    ...
    /**
     * Checks that the API rejects unauthorized requests.
     * Ensures that status code is not 201 (Created), meaning the book was not added.
     */
